...
export const DISEASE_LIBRARY: DiseaseGuide[] = [
...

    {
        ...
        plant: 'Mango', plant_emoji: '🥭', severity: 'high', thumbnail: mango_anthracnose_thumbnail,
...

    {
        ...
        plant: 'Mango', plant_emoji: '🥭', severity: 'high', thumbnail: mango_pmildew_thumbnail,
...

    {
        ...
        plant: 'Mango', plant_emoji: '🥭', severity: 'moderate', thumbnail: mango_sootymould_thumbnail,
        tagline: 'Black soot that blocks light and signals an insect infestation',
        overview: 'Sooty mould on mango is not a primary pathogen but a secondary fungal growth caused by several genera — primarily Capnodium, Meliola, and Fumago species — that colonize the honeydew secreted by sap-sucking insects such as mango hoppers (Idioscopus nitidulus), mealybugs, scale insects, and aphids. The black coating physically blocks sunlight from reaching leaf surfaces, reducing photosynthesis and overall tree vigor. Managing sooty mould requires controlling the insect infestation that provides the honeydew substrate.',
        scientific_name: 'Capnodium mangiferae / Meliola mangiferae',
        pathogen_type: 'Fungal (secondary)',
        pathogen_detail: 'Multiple fungal species colonize insect honeydew secreted onto leaf and fruit surfaces. The fungi are not parasitic — they do not penetrate plant tissue. They simply grow on the sugar-rich honeydew as a food source. Controlling insects removes the honeydew, eliminating the fungal substrate.',
        ...
        symptoms: {
            ...
            distinguishing: 'The sooty coating WIPES OFF easily with a wet cloth, revealing healthy green tissue beneath. This is the definitive distinguishing feature from true leaf diseases. Presence of visible insect colonies or ants confirms the secondary nature of the mould.',
        },
        conditions: {
        ...
        economic_impact: 'Reduces photosynthesis by 30–50% in heavily coated trees. Fruit coated with sooty mould is unmarketable without costly washing. Mango hopper infestations causing sooty mould can reduce fruit set by 20–40%.',
        look_alikes: ['Powdery mildew (WHITE coating, not black; cannot be wiped off)', 'Anthracnose on leaves (dark spots but not coating; tissue is necrotic not wiping-off)', 'Normal leaf dust or smoke deposit (uniform, no insect association)'],
        treatment: {
            immediate: [
            ...
            chemical: [
                { product: 'Imidacloprid 200 SC (for hoppers/aphids)', rate: '0.5 mL/L water', frequency: 'Single application at infestation onset; repeat after 21 days if needed' },
                { product: 'Profenofos 50% EC (for mealybugs/scale)', rate: '2 mL/L water', frequency: 'Every 14 days until infestation controlled' },
                { product: 'Mineral oil 97% EC (suffocant + mould removal)', rate: '10–20 mL/L water', frequency: 'Every 14 days; physically smothers insects and dissolves honeydew film' },
            ],
            organic: [
        ...
        recovery_timeline: 'Once insects are controlled, new leaves will be clean. Existing sooty mould fades and flakes off over 4–8 weeks as leaves age and are washed by rain. Fruit surface mould can be washed before sale.',
        fun_fact: 'The ants farming mealybugs on mango trees are engaging in one of the oldest mutualistic relationships in insects — ants protect mealybugs from predators in exchange for honeydew, a behavior documented for over 50 million years in the fossil record.',
    },

    {
        id: 'mango_healthy',
        display_name: 'Healthy Mango',
        plant: 'Mango', plant_emoji: '🥭', severity: 'low', thumbnail: mango_healthy_thumbnail,
...

    {
        ...
        symptoms: {
            ...
            distinguishing: 'Cordana lesions are distinctly oval with a characteristic pale gray/tan center, dark brown margin, and yellow outer halo — a "target spot" appearance. Black Sigatoka lesions are more elongated (streak-to-spindle shaped) and follow a precise 6-stage progression. Cordana lesions are generally larger and more irregular in shape.',
        },
        conditions: {
        ...
        economic_impact: 'Primarily a secondary disease but causes significant yield losses in poorly managed plantations through premature leaf death. In nurseries, can kill seedling batches entirely. Estimated 10–25% yield reduction when combined with Sigatoka in untreated fields.',
        look_alikes: ['Black Sigatoka (elongated streaks/spindle lesions; strict 6-stage sequence)', 'Helminthosporium leaf spot (diamond-shaped lesions, darker brown)', 'Physical leaf damage / wind tattering (irregular tears, no halos)'],
        treatment: {
            immediate: [
            ...
            chemical: [
                { product: 'Mancozeb 80% WP', rate: '2.5 g/L water', frequency: 'Every 14 days during rainy season' },
                { product: 'Chlorothalonil 75% WP', rate: '2 g/L water', frequency: 'Every 14 days; good contact activity' },
                { product: 'Propiconazole 25% EC', rate: '1 mL/L water', frequency: 'Every 21 days; systemic; rotate with mancozeb' },
            ],
            organic: [
        ...
        recovery_timeline: 'Once lesions form, affected leaf tissue cannot recover. New leaves emerging with consistent fungicide protection will be clean. Plantation-level disease reduction: 4–8 weeks of consistent program.',
        fun_fact: 'Cordana musae was originally described from banana specimens collected in Jamaica in 1880, making it one of the earliest documented banana fungal pathogens — predating the discovery of both Panama disease and Sigatoka by several decades.',
    },

    {
        id: 'banana_sigatoka',
        display_name: 'Black Sigatoka',
        plant: 'Banana', plant_emoji: '🍌', severity: 'critical', thumbnail: banana_sigatoka_thumbnail,
        ...
        economic_impact: 'Reduces bunch weight 35–50% in untreated plantations. Global management cost: $400M+/year in fungicides. Primary reason Cavendish production requires 10–50 aerial fungicide applications annually in commercial operations.',
        look_alikes: ['Yellow Sigatoka (similar but slower, yellower lesions, less aggressive)', 'Cordana leaf spot (oval target-spot lesions, not elongated streaks)', 'Potassium deficiency (yellowing starting at leaf margins, no spots)'],
        treatment: {
            immediate: [
...

    {
        ...
        plant: 'Banana', plant_emoji: '🍌', severity: 'critical', thumbnail: banana_panama_thumbnail,
        ...
        economic_impact: 'Has devastated entire Cavendish export industries across Asia. Estimated $150–400M in losses in Taiwan alone. With no cure and permanent soil infestation, infected farms face permanent loss of banana production unless switching to resistant varieties.',
        ...
        fun_fact: 'The Gros Michel banana — the variety that dominated global exports until the 1950s — was wiped out by an earlier Fusarium race (Race 1). The Cavendish replaced it, and now TR4 is threatening Cavendish the same way Race 1 threatened Gros Michel.',
    },

    {
        id: 'banana_healthy',
        display_name: 'Healthy Banana',
        plant: 'Banana', plant_emoji: '🍌', severity: 'low', thumbnail: banana_healthy_thumbnail,
        ...
        economic_impact: 'Philippine banana exports (primarily Cavendish from Mindanao) earn $800M–$1B USD annually. A healthy managed hectare produces 30–50 tonnes of export-grade Cavendish.',
        ...
        fun_fact: "A banana 'tree' is botanically the world's largest herbaceous plant — the 'trunk' (pseudostem) is made entirely of tightly rolled leaf bases with no woody tissue at all.",
    },
...

    {
        ...
        plant: 'Guava', plant_emoji: '🍈', severity: 'moderate', thumbnail: guava_anthracnose_thumbnail,
...

    {
        ...
        economic_impact: 'Can cause complete defoliation of young trees, delaying first fruiting by 1–2 years. On bearing trees, repeated defoliation reduces yield by 30–50%. A significant threat to agroforestry systems using Myrtaceae species as shade trees.',
        look_alikes: ['Algal leaf spot (green not orange; very different texture)', 'Spray residue from sulfur fungicides (yellow but no pustule structure)', 'Normal new leaf reddening (uniform color change, no pustules or powder)'],
        treatment: {
            immediate: [
            ...
            chemical: [
                { product: 'Triadimefon 25% WP (triazole)', rate: '1 g/L water', frequency: 'Every 10–14 days; excellent systemic activity against rust fungi' },
                { product: 'Azoxystrobin 25% SC (strobilurin)', rate: '1 mL/L water', frequency: 'Every 14 days; protectant and curative; rotate with triazoles' },
                { product: 'Mancozeb 80% WP (protectant)', rate: '2.5 g/L water', frequency: 'Every 7–10 days during active flush stage as protective cover' },
                { product: 'Copper oxychloride 50% WP', rate: '2.5 g/L water', frequency: 'Every 10–14 days; general protectant at flush emergence' },
            ],
            organic: [
        ...
        recovery_timeline: 'Infected young tissue cannot recover. New flush protected by fungicide program will be clean. Defoliated trees regenerate new canopy within 4–8 weeks if disease is controlled. Young tree growth delay: potentially 3–6 months for severely defoliated plants.',
        fun_fact: 'Puccinia psidii (guava rust) is considered one of the most significant biosecurity threats to Australia\'s native ecosystems, where it threatens over 400 native Myrtaceae species including iconic eucalyptus trees. In 2010 it was detected in Australia and triggered a national biosecurity emergency response.',
    },

    {
        id: 'guava_healthy',
        display_name: 'Healthy Guava',
        plant: 'Guava', plant_emoji: '🍈', severity: 'low', thumbnail: guava_healthy_thumbnail,
...

    {
        ...
        plant: 'Calamansi', plant_emoji: '🍊', severity: 'moderate', thumbnail: calamansi_blackspot_thumbnail,
        tagline: 'Fruit-blemishing fungal spots that destroy market value',
        overview: 'Citrus black spot (CBS), caused by Phyllosticta citricarpa, is a fungal disease that primarily attacks maturing citrus fruit, producing distinctive black spots and blemishes that make fruit commercially unmarketable. While the disease rarely causes significant tree damage, it is a major economic concern due to its impact on fruit appearance and quality. CBS is a quarantine pest in several countries including the USA and Europe, severely restricting export of Philippine calamansi to these markets. It thrives in warm, humid conditions during the fruit development period.',
        scientific_name: 'Phyllosticta citricarpa',
        pathogen_type: 'Fungal',
        pathogen_detail: 'Ascomycete fungus that infects fruit through the skin (pericarp) and can remain quiescent (latent) for months before symptoms appear as fruit matures. Produces pycnidia (flask-shaped fruiting bodies) in lesion centers visible as small black dots. Spores are dispersed by rain splash from infected fallen fruit and dead leaves.',
        ...
        economic_impact: 'Quarantine pest status in USA and EU effectively bars Philippine calamansi exports to these markets. On domestic market, heavily spotted fruit sells at 40–60% discount. Post-harvest losses from secondary rots entering through cracked spots can reach 20–30%.',
        look_alikes: ['Citrus canker (raised corky lesions with oily water-soaked margins; affects leaves too)', 'Melanose (tiny uniform raised dots; no yellow halo; all uniform size)', 'Physical insect damage (puncture wounds without halo pattern)', 'Greasy spot (yellow-brown blotches on leaves; no defined lesion structure on fruit)'],
        treatment: {
            immediate: [
            ...
            chemical: [
                { product: 'Copper hydroxide 77% WP', rate: '2.5 g/L water', frequency: 'Every 14 days during fruit development; primary protectant' },
                { product: 'Carbendazim 50% WP', rate: '1 g/L water', frequency: 'Every 14 days; systemic activity against Phyllosticta' },
                { product: 'Azoxystrobin 25% SC', rate: '1 mL/L water', frequency: 'Every 21 days; rotate with copper-based products' },
                { product: 'Mancozeb 80% WP', rate: '2 g/L water', frequency: 'Every 10–14 days; protective coverage during rainy periods' },
            ],
            organic: [
        ...
        recovery_timeline: 'Existing lesions on fruit are permanent and cannot be reversed. New fruit protected by timely fungicide program from petal fall will have significantly fewer blemishes. Full tree management results visible in following season.',
        fun_fact: 'Citrus black spot was first described from South Africa in 1895 and spread globally through infected planting material during the 20th century. Its current quarantine pest status in over 30 countries makes it one of the most economically impactful citrus pathogens from a trade restriction perspective, even though the disease itself does not threaten tree survival.',
    },

    {
        id: 'calamansi_greening',
        display_name: 'Citrus Greening (HLB)',
        plant: 'Calamansi', plant_emoji: '🍊', severity: 'critical', thumbnail: calamansi_greening_thumbnail,
        ...
        pathogen_detail: 'Gram-negative, phloem-limited bacterium — lives only in the plant\'s phloem (sugar-conducting vessels). Cannot be cultured on artificial media, making research extremely difficult. Transmitted exclusively by the Asian citrus psyllid (Diaphorina citri) — no other transmission route.',
        ...
        symptoms: {
            ...
            distinguishing: 'The ASYMMETRIC blotchy leaf mottling is the key diagnostic feature — nutrient deficiencies create SYMMETRIC mirror-image yellowing, while HLB creates random, asymmetric patches crossing veins freely. The lopsided green-bottomed fruit symptom is pathognomonic and confirms HLB definitively.',
        },
        conditions: {
        ...
        economic_impact: 'Florida citrus industry lost $8 billion and 70% of production since HLB arrival in 2005. In the Philippines, threatens the ₱2 billion calamansi industry. No commercial variety is immune.',
        look_alikes: ['Zinc deficiency (symmetric, uniform interveinal yellowing)', 'Magnesium deficiency (symmetric interveinal yellowing of older leaves)', 'Citrus tristeza virus (no fruit greening symptom)'],
        treatment: {
            immediate: [
        ...
        recovery_timeline: 'No recovery. Infected trees decline progressively over 5–10 years. Antibiotic trunk injections extend productive life 2–3 years but are not economically viable for smallholders.',
        fun_fact: "Candidatus Liberibacter asiaticus has never been successfully grown in laboratory culture despite decades of intensive research — making it one of the only major global agricultural pathogens that remains 'unculturable.'",
    },

    {
        id: 'calamansi_canker',
        display_name: 'Citrus Canker',
        plant: 'Calamansi', plant_emoji: '🍊', severity: 'high', thumbnail: calamansi_canker_thumbnail,
        ...
        pathogen_detail: 'Gram-negative rod-shaped bacterium entering plant tissue through stomata and wounds. Infects both young and mature tissues. Produces distinctive raised corky eruptions due to hypertrophy of infected cells.',
        ...
        conditions: {
            ...
            spread_method: 'Wind-driven rain splash; contaminated pruning tools; infected planting material; citrus leafminer tunnels',
        },
        ...
        look_alikes: ['CBS / Citrus black spot (sunken spots without oily margins)', 'Melanose (tiny uniform dots; no oily margin or prominent halo)', 'Wind damage (mechanical scarring without yellow halo)'],
        treatment: {
            immediate: [
        ...
        recovery_timeline: 'Existing lesions on leaves and fruit are permanent. New growth after adequate copper protection will be clean. Full canopy recovery: 2–4 months with consistent copper program and leafminer control.',
        fun_fact: 'The 2005–2006 citrus canker eradication campaign in Florida involved destroying over 8 million residential citrus trees at a cost of $1 billion — only for the eradication to ultimately fail when Tropical Storm Fay in 2008 spread the bacteria too widely.',
    },

    {
        id: 'calamansi_healthy',
        display_name: 'Healthy Calamansi',
        plant: 'Calamansi', plant_emoji: '🍊', severity: 'low', thumbnail: calamansi_healthy_thumbnail,
        ...
        symptoms: {
            ...
            distinguishing: 'Healthy calamansi has perfectly SYMMETRIC leaf coloring. Any yellowing follows uniform vein patterns (suggesting nutrient issues) rather than random blotchy patches (which strongly suggests HLB). The winged petiole is a morphological identifier unique to calamansi among Philippine citrus.',
        },
        conditions: {
        ...
        economic_impact: 'Philippine calamansi production exceeds 100,000 tonnes annually with a farmgate value of ₱2+ billion. Used in juice concentrate, personal care products, traditional herbal medicine, condiments, and marinades.',
        look_alikes: ['HLB infection (asymmetric mottling vs. healthy uniform green)', 'Normal immature green fruit vs. HLB-infected green fruit that does not fully color'],
        treatment: {
        ...
        fun_fact: "Calamansi is botanically a hybrid between kumquat (Fortunella japonica) and mandarin orange (Citrus reticulata), which explains its small size (kumquat heritage) combined with its juicy interior and sour-sweet flavor profile (mandarin heritage).",
    },
];
