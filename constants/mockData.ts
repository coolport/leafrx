export const myPlants = [
  ...
  export const diseases = [
    { 
      ...
      color: '#fee2e2', 
      textColor: '#991b1b',
      description: 'Anthracnose is a group of fungal diseases that affects a variety of plants, particularly in warm, humid climates. It causes dark, sunken lesions on leaves, stems, flowers, and fruits.',
      symptoms: [
    ...
    { 
      ...
      color: '#fef3c7', 
      textColor: '#854d0e',
      description: 'Bacterial leaf spot is a common disease affecting many plants, caused by various species of bacteria. It leads to small, water-soaked spots on leaves that turn dark brown or black.',
      symptoms: [
    ...
    { 
      ...
      color: '#dcfce7', 
      textColor: '#166534',
      description: 'Powdery mildew is a fungal disease that affects a wide range of plants. It is easily recognized by the white, powdery spots that appear on the leaves and stems.',
      symptoms: [
    ...
    { 
      ...
      color: '#fee2e2', 
      textColor: '#991b1b',
      description: 'Citrus canker is a highly contagious bacterial disease that affects citrus trees, causing lesions on leaves, stems, and fruit. It is a serious threat to citrus production worldwide.',
      symptoms: [
    ...
    { 
      ...
      color: '#fef3c7', 
      textColor: '#854d0e',
      description: 'Mango malformation is a serious disease that affects mango trees, characterized by the abnormal development of vegetative or floral tissues.',
      symptoms: [
    ...
    { 
      ...
      color: '#fee2e2', 
      textColor: '#991b1b',
      description: 'Banana bunchy top is a viral disease that causes severe stunting and reduces fruit yield in banana plants. It is transmitted by aphids.',
      symptoms: [
