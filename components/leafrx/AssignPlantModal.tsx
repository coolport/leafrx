            ...
            <View style={styles.modalContainer}>
                <View style={[styles.modalContent, { backgroundColor: colors.card }]}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 6 }}>
                        <View>
                            <Text style={[styles.modalTitle, { color: colors.text }]}>Assign to Plant</Text>
                        ...
                        {plants.length > 0 ? (
                            ...
                            <View style={{ alignItems: 'center', paddingVertical: 32, gap: 10 }}>
                                <View style={{
                                    ...
                                    <Feather name="inbox" size={24} color={colors.subtext} />
                                </View>
                    ...
                    <TouchableOpacity
                        activeOpacity={0.7}
                        style={[styles.btnSecondary, { width: '100%', backgroundColor: colors.secondary, borderColor: colors.border }]}
                        onPress={onClose}
                    >
